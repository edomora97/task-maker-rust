...
["task_maker_rust",["",[["tools",[["find_bad_case",[],["curses_ui.rs","dag.rs","finish_ui.rs","mod.rs","state.rs"]]],["add_solution_checks.rs","booklet.rs","clear.rs","copy_competition_files.rs","fuzz_checker.rs","gen_autocompletion.rs","mod.rs","opt.rs","reset.rs","sandbox.rs","server.rs","task_info.rs","typescriptify.rs","worker.rs"]]],["context.rs","copy_dag.rs","error.rs","lib.rs","local.rs","opt.rs","remote.rs","sandbox.rs"]]],\
